...
const getUserList = (params) => {
  users(params).then(users => {
      ...
      data.value = users.data.data
      totalPages.value = users.data.meta.pagination.total_pages
      page.value = users.data.meta.pagination.current_page
  })
} 
